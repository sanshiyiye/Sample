...
namespace TMPro
{
    ...
    public partial class TextMeshProUGUI
    {
        public TextMeshProUGUI()
        {
            ...
            // Debug.Log("***** Constructer() called on object ID " + GetInstanceID() + ". *****");
#if TMP_POOL
                ...
                if (isCharacterVisible)
                {
                    ...
                    switch (elementType)
                    {
                        ...
                        case TMP_TextElementType.Character:
                            ...
                            // normal -> color
                            characterInfos[i].vertex_BL.normal = underLayColorFloat;
                            characterInfos[i].vertex_TL.normal = underLayColorFloat;
                            characterInfos[i].vertex_TR.normal = underLayColorFloat;
                            characterInfos[i].vertex_BR.normal = underLayColorFloat;
