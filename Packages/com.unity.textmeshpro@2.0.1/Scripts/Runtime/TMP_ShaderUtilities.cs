...
namespace TMPro
{
    public static class ShaderUtilities
    {
        ...
        public static void UpdateShaderRatios(Material mat, TMP_Text text)
        {
            ...
            float faceDilate = text ? text.faceDilate : 0f;
            // float outlineThickness = mat.GetFloat(ID_OutlineWidth);
            float outlineThickness = text ? text.outlineWidth : 0f;
            ...
            // if (mat.HasProperty(ID_UnderlayOffsetX))
            {
                ...
                float underlayOffsetX = text ?  text.underlayOffsetX : 0f;
                // float underlayOffsetY = mat.GetFloat(ID_UnderlayOffsetY);
                float underlayOffsetY = text ? text.underlayOffsetY : 0f;
                // float underlayDilate = mat.GetFloat(ID_UnderlayDilate);
                float underlayDilate = text ? text.underlayDilate : 0f;
        ...
        public static float GetPadding(Material material, bool enableExtraPadding, bool isBold, TMP_Text text)
        {
            ...
            scaleRatio_A = text ? text.scaleRatioA : 1f;
            ...
            faceDilate = text ? text.faceDilate * scaleRatio_A : 0f;
            ...
            outlineThickness = text ? text.outlineWidth * scaleRatio_A : 0f;
            ...
            // if (material.HasProperty(ID_UnderlaySoftness) && shaderKeywords.Contains(Keyword_Underlay)) // Generates GC
            {
                ...
                scaleRatio_C = text ? text.scaleRatioC : 1f;
                ...
                float offsetX = text ? text.underlayOffsetX * scaleRatio_C : 0f;
                float offsetY = text ? text.underlayOffsetY * scaleRatio_C : 0f;
                float dilate = text ? text.underlayDilate * scaleRatio_C : 0f;
