...
*/
 ...
 public class MoonList<T> :IEnumerable<T>
{
  protected int m_capacity=100000;  // 容量
        ...
        public MoonList(int capacity,int enumCount=5)
        {
            init(enumCount);
        }
        ...
        struct ABEnumerator<T> : IDisposable, IEnumerator<T>
        {
           ...
           public  object Current
            ...
            internal ABEnumerator(MoonList<T> list,int id)
            {
                this.m_list = list;
                this.m_idNext = 0;
                this.m_id=id;
