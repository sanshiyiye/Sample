...
namespace Sirenix.OdinInspector.Demos.RPGEditor
{
    ...
    public class RPGEditorWindow : OdinMenuEditorWindow
    {
        ...
        protected override OdinMenuTree BuildMenuTree()
        {
            ...
            // Adds the _searchItem overview table.
        ...
        protected override void OnBeginDrawEditors()
        {
            ...
            SirenixEditorGUI.BeginHorizontalToolbar(toolbarHeight);
            {
                ...
                if (SirenixEditorGUI.ToolbarButton(new GUIContent("Create SearchItem")))
                {
                    ScriptableObjectCreator.ShowDialog<Character>("Assets/Plugins/Sirenix/Demos/Sample - RPG Editor/SearchItem", obj =>
                    {
                        obj.Name = obj.name;
                        base.TrySelectMenuItemWithObject(obj); // Selects the newly created item in the editor
                    });
