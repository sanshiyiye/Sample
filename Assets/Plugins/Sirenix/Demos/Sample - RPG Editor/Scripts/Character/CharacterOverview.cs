...
namespace Sirenix.OdinInspector.Demos.RPGEditor
{
    ...
    // in the Unity project. When a _searchItem is added from the RPG editor, the
    // list then gets automatically updated via UpdateCharacterOverview. 
    //
    // If you inspect the SearchItem Overview in the inspector, you will also notice, that
    ...
    public class CharacterOverview : GlobalConfig<CharacterOverview> 
    {
        ...
        {
            // Finds and assigns all scriptable objects of type SearchItem
            this.AllCharacters = AssetDatabase.FindAssets("t:SearchItem")
