...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp15(bool p0, UnityEngine.Sprite p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp20(FrameWork.UI.UIController p0, object[] p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public int __Gen_Delegate_Imp28(int p0, string p1, out Tutorial.CSCallLua.DClass p2)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public System.Action __Gen_Delegate_Imp29()
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public XLuaTest.InvokeLua.ICalc __Gen_Delegate_Imp30(int p0, string[] p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(FrameWork.Runtime.Resource.AbstractResourceLoader.CAssetBundleLoaderDelegate))
			{
			    return new FrameWork.Runtime.Resource.AbstractResourceLoader.CAssetBundleLoaderDelegate(__Gen_Delegate_Imp2);
			}
		    ...
		    if (type == typeof(FrameWork.Runtime.Resource.ResourceModule.CKSpriteAtlasLoaderDelegate))
			{
			    return new FrameWork.Runtime.Resource.ResourceModule.CKSpriteAtlasLoaderDelegate(__Gen_Delegate_Imp15);
			}
		    ...
		    if (type == typeof(FrameWork.Runtime.Resource.AbstractResourceLoader.LoaderDelgate))
			{
			    return new FrameWork.Runtime.Resource.AbstractResourceLoader.LoaderDelgate(__Gen_Delegate_Imp18);
			}
		    ...
		    if (type == typeof(System.Action<FrameWork.UI.UIController, object[]>))
			{
			    return new System.Action<FrameWork.UI.UIController, object[]>(__Gen_Delegate_Imp20);
			}
		
		    if (type == typeof(UnityEngine.Events.UnityAction<string, string>))
			{
			    return new UnityEngine.Events.UnityAction<string, string>(__Gen_Delegate_Imp21);
			}
			...
			{
			    return new Tutorial.CSCallLua.FDelegate(__Gen_Delegate_Imp28);
			}
		
		    if (type == typeof(Tutorial.CSCallLua.GetE))
			{
			    return new Tutorial.CSCallLua.GetE(__Gen_Delegate_Imp29);
			}
		
		    if (type == typeof(XLuaTest.InvokeLua.CalcNew))
			{
			    return new XLuaTest.InvokeLua.CalcNew(__Gen_Delegate_Imp30);
			}
